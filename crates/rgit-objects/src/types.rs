...
impl SignaturePurpose {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ApprovalEvidence => "approval-evidence",
            Self::CiEvidence => "ci-evidence",
            Self::PolicyDecisionEvidence => "policy-decision-evidence",
...
impl TryFrom<&str> for SignaturePurpose {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
            ...
            "repository-root" => Ok(Self::RepositoryRoot),
            "identity" => Ok(Self::Identity),
            "group-membership" => Ok(Self::GroupMembership),
            "conflict-resolution" => Ok(Self::ConflictResolution),
            "review-evidence" => Ok(Self::ReviewEvidence),
            "approval-evidence" => Ok(Self::ApprovalEvidence),
            "ci-evidence" => Ok(Self::CiEvidence),
            "policy-decision-evidence" => Ok(Self::PolicyDecisionEvidence),
...
impl TryFrom<u64> for SignaturePurpose {
    ...
    fn try_from(value: u64) -> Result<Self, Self::Error> {
        match value {
            ...
            3 => Ok(Self::Release),
            4 => Ok(Self::Policy),
            5 => Ok(Self::RepositoryRoot),
            6 => Ok(Self::Identity),
            7 => Ok(Self::GroupMembership),
            8 => Ok(Self::ConflictResolution),
            9 => Ok(Self::ReviewEvidence),
            10 => Ok(Self::ApprovalEvidence),
            11 => Ok(Self::CiEvidence),
            12 => Ok(Self::PolicyDecisionEvidence),
            13 => Ok(Self::BuildProvenance),
            14 => Ok(Self::View),
            15 => Ok(Self::Migration),
            other => Err(other),
        }
    }
}
...
pub enum ObjectKind {
    ...
    KeyEnvelopeSet = 17,
    ChangeRelation = 18,
    ConflictResolution = 19,
    ReviewEvidence = 20,
    ApprovalEvidence = 21,
    CiEvidence = 22,
    PolicyDecisionEvidence = 23,
    ProjectionRules = 24,
    ProjectionProof = 25,
    BuildProvenance = 26,
    Artifact = 27,
...
impl TryFrom<u64> for ObjectKind {
    ...
    fn try_from(value: u64) -> Result<Self, Self::Error> {
        Ok(match value {
            ...
            12 => Self::Release,
            13 => Self::Policy,
            14 => Self::RepositoryRoot,
            15 => Self::Identity,
            16 => Self::GroupMembership,
            17 => Self::KeyEnvelopeSet,
            18 => Self::ChangeRelation,
            19 => Self::ConflictResolution,
            20 => Self::ReviewEvidence,
            21 => Self::ApprovalEvidence,
            22 => Self::CiEvidence,
            23 => Self::PolicyDecisionEvidence,
            24 => Self::ProjectionRules,
            25 => Self::ProjectionProof,
            26 => Self::BuildProvenance,
            27 => Self::Artifact,
            28 => Self::OperationPayload,
            29 => Self::View,
            30 => Self::Migration,
            31 => Self::Ruleset,
